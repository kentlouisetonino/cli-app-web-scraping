## Description
> A CLI program that will allow you to scrape Wikipedia information. After the scraping process, it will save the data into a Comma Separated Values (CSV) file. For now this will scrape only the Wikipedia's Sister Projects.
